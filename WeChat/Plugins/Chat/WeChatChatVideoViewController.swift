//
//  WeChatChatVideoViewController.swift
//  WeChat
//
...
//聊天窗口Video
class WeChatChatVideoViewController: UIViewController {

    
    var totalTimer: String!
    var playItem: AVPlayerItem!
    var playView: WeChatChatAVPlayView!
    var timerObserver: AnyObject?
    
    init() {
        super.init(nibName: nil, bundle: nil)
        playView = WeChatChatAVPlayView(frame: view.bounds)
